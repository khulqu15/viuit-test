...
export default {
    ...
    mounted() {
        ...
        this.form.role = this.user_data.role
    },
    methods: {
        onSubmit() {
            this.form.post(this.route('user.update', this.user_data.hash), {
                preserveState: true,
                preserveScroll: true
            })
        },
        ...
        <div class="py-12">
            <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg">
                    <div class="p-8">
                        <h1 class="text-2xl font-bold mb-3">Edit User</h1>
                        ...
                        <form class="space-y-4" @submit.prevent="onSubmit()">
                            ...
                            <div class="grid md:grid-cols-2 grid-cols-1 gap-4">
                                <div class="form-control w-full">
                                    ...
                                    <input v-model="form.password" maxlength="100" :type="!show_password ? 'text':'password'" placeholder="User Password" class="input input-bordered w-full focus:border-rose-600 focus:outline-bg-rose-400" />
